...
class _TFServingDemoState extends State<TFServingDemo> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text('News Source Verification'),
        ),
        body: Center(
          child: Container(
                ...
                children: [
                  TextField(
                    ...
                    decoration: const InputDecoration(
                        ...
                        hintText: 'Enter a news headline here ...'),
                  ),
                  Column(
                    children: <Widget>[
                      ListTile(
    ...
    if (_connectionMode == ConnectionModeType.rest) {
      ...
      if (response.statusCode == 200) {
        ...
        if (result['predictions']![0][1] >= classificationThreshold) {
          return 'This news headline is from verified source. Verified Source score is ' +
              result['predictions']![0][1].toString();
        }
        return 'This news headline is from unverified source. Verified Source score is  ' +
            result['predictions']![0][1].toString();
      } else {
